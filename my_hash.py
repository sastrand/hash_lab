...
if __name__ == '__main__':
    ...
    print("Hash 0 collision rate: {}"
           .format(run_hash(my_hash_0, uuid_full)))

    print("Hash 1 collision rate: {}"
           .format(run_hash(my_hash_1, uuid_full)))

    print("Hash 2 collision rate: {}"
       .format(run_hash(my_hash_2, uuid_full)))

    print("Python hash collision rate: {}"
        .format(run_hash(hash, uuid_full)))
